public class ExtendedEuclideanAlgorithm {
    ...
    public static int inverseEA(int a, int b){
    ...
    public static void main(String[] args){
        System.out.println(inverseEA(25, 100));
        System.out.println(inverseEA(26, 100));
        System.out.println(inverseEA(100, 26));
        System.out.println(inverseEA(1701, 3768));
        System.out.println(inverseEA(10, 45));
        System.out.println(inverseEA(710, 310));
        System.out.println(inverseEA(310, 710));
    }
}
